    ...
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mt-2">
            <ol class="flex items-center gap-1 text-sm text-gray-600">
                ...
                <li>
                    <a href="/keluarga" class="block transition hover:text-gray-700"> Meninggal </a>
                </li>
            </ol>
        </nav>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                   <!-- With actions -->
                    ...
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <table class="w-full whitespace-no-wrap" id="tabelMeninggal">
                            <thead>
                            <tr
                            ...
                            >
                                ...
                                <th class="px-4 py-3">Lokasi Pemakaman</th>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    {{ $meninggal['date_meninggal'] }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ $meninggal['jam'] }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ $meninggal['lokasi_meninggal'] }}
                                </td>
                                <td class="px-4 py-3 text-sm">
                                    {{ $meninggal['lokasi_pemakaman'] }}
                                </td>
                                <td class="px-2 py-2">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a
                                          class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-green-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                          aria-label="Edit" href="{{ route('meninggal.edit', ['meninggal' => $meninggal->id]) }}" 
                                        >
                                          <svg
                                            class="w-5 h-5"
                                            aria-hidden="true"
                                        ...
                                        <form action="{{ route('meninggal.destroy', ['meninggal' => $meninggal->id]) }}" method="post" class="d-inline">
                                            @method('DELETE')
                                            @csrf
                                            <button
                                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-green-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
