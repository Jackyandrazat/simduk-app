<x-admin-layout>
    ...
    <div class="relative inline-block text-right py-2">
        <button id="toggleDropdown" type="button" class="float-right flex items-center justify-end px-4 py-2 mr-5 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-900 focus:outline-none focus:shadow-outline-green">
