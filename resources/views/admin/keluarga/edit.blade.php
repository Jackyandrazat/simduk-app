<x-admin-layout>
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mt-2">
            <ol class="flex items-center gap-1 text-sm text-gray-600">
                ...
                <li>
                    <a href="{{ route('keluarga.edit', ['keluarga' => $keluarga->id]) }}" class="block transition hover:text-gray-700"> Edit Keluarga </a>
                </li>
            </ol>
        </nav>
    </x-slot>
    ...
    <div>
        <div class="container px-6 mx-auto grid">
            ...
            >
            <form action="{{ route('keluarga.edit', ['keluarga' => $keluarga->id]) }}" method="POST">
                @csrf
                    @method('PUT')
                    <label class="block text-sm mt-5">
                        ...
                        placeholder="Jane Doe"  name="no_kk" value="{{ $keluarga->no_kk }}" required
                        />
                    </label>
