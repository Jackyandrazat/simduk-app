<x-admin-layout>
    ...
    <div>
        <div class="relative py-5 my-5">
            <a class="flex absolute top-0 right-8 items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green"
                                ...
                                @foreach ($tamus as $tamu)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-semibold">{{ $tamu->tamuRelation->nama }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-2 py-2">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-green-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                    aria-label="Edit"
                                                    href="{{ route('tamu.edit', ['tamu' => $tamu->id]) }}">
                                                ...
                                                <form action="{{ route('tamu.destroy', ['tamu' => $tamu->id]) }}"
