    ...
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mt-2">
            <ol class="flex items-center gap-1 text-sm text-gray-600">
                ...
                <li>
                    <a href="/keluarga" class="block transition hover:text-gray-700"> Kendaraan </a>
                </li>
            </ol>
        </nav>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                   <!-- With actions -->
                    ...
                    >
                        Daftar Kendaraan Warga
                    </h4>
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap" id="tabelKendaraan">
                            <thead>
                            <tr
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-2 py-2">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <form action="{{ route('kendaraan.destroy', ['kendaraan' => $kendaraan->id]) }}" method="post" class="d-inline">
                                            @method('DELETE')
                                            @csrf
                                            <button
                                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-green-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
