<x-admin-layout>
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mt-2">
            <ol class="flex items-center gap-1 text-sm text-gray-600">
                ...
                <li>
                    <a href="{{ route('kendaraan.edit', ['kendaraan' => $kendaraan->id]) }}" class="block transition hover:text-gray-700"> Edit Data Kendaraan </a>
                </li>
            </ol>
        </nav>
    </x-slot>
    ...
    <div>
        <div class="container px-6 mx-auto grid">
            ...
            >
            <form action="{{ route('kendaraan.edit', ['kendaraan' => $kendaraan->id]) }}" method="POST">
                @csrf
                    @method('PUT')
