<x-admin-layout>
    <x-slot name="header">
        ...
        <nav aria-label="Breadcrumb" class="mt-2">
            <ol class="flex items-center gap-1 text-sm text-gray-600">
                ...
                <li>
                    <a href="{{ route('rt.edit', ['rt' => $rt->id]) }}" class="block transition hover:text-gray-700"> Edit Data RT </a>
                </li>
            </ol>
        </nav>
    </x-slot>
    ...
    <div>
        <div class="container px-6 mx-auto grid">
            ...
            >
            <form action="{{ route('rt.edit', ['rt' => $rt->id]) }}" method="POST">
                @csrf
                    @method('PUT')
                    ...
                    <label class="block text-sm mt-3"><nav aria-label="Breadcrumb" class="mt-2">
                        <ol class="flex items-center gap-1 text-sm text-gray-600">
                            <li>
                                <a href="/home" class="block transition hover:text-gray-700">
                                    <span class="sr-only"> Home </span>
                        ...
                        placeholder="Jabatan" name="jabatan" value="{{ $rt->jabatan }}" required
                        />
                    </label>
                    <label class="block text-sm mt-5">
                        ...
                        <input
                        class="block w-full mt-1 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Jane Doe"  name="tanggal_diangkat" value="{{ $rt->tanggal_diangkat }}" required
                        />
                    </label>
                    <label class="block text-sm mt-5">
                        ...
                        <input
                        class="block w-full mt-1 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Jane Doe"  name="tanggal_selesai" value="{{ $rt->tanggal_selesai }}" required
                        />
                    </label>
                    <label class="block text-sm mt-5">
                        ...
                        <input
                        class="block w-full mt-1 text-sm rounded-lg dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="Jane Doe"  name="keterangan" value="{{ $rt->keterangan }}" required
                        />
                    </label>
                    <div class="py-5">
                        <button
